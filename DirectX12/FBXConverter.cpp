...
void FBXConverter::fbxToTxt(const char* fbxFilename, const char* txtFilename, float fx = 1, float fy = 1, float fz = 1, int idx0 = 0, int idx1 = 1, int idx2 = 2)
{
	//FbxManager作成
...
void FBXConverter::CreateText(const char* fbxFilename, const char* txtFilename,float x = 1, float fy = 1, float fz = 1,int idx0 = 0, int idx1 = 1, int idx2 = 2)
{
	std::ofstream ofs(txtFilename);
